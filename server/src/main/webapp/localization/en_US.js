...
document.localization ['en_US'] = {
    ...
    'device.appusage.col.started': 'Started',
    'device.appusage.col.ended': 'Ended',
    'device.appusage.col.duration': 'Duration',
    ...
    'device.location.empty': 'No location has been reported by this device yet.',
    ...
    'question.device.command.lock': 'Lock the device "${deviceNumber}" now?',
    'question.device.command.reboot': 'Reboot the device "${deviceNumber}" now?',
    'question.device.command.wipe': 'Factory reset the device "${deviceNumber}"? This will erase device data.',
    ...
    'error.invalid.device.command': 'Unsupported device command',
    'error.notfound.device.location': 'No location has been reported by this device yet',
    ...
    'success.device.command.sent': 'The remote command has been sent to the device.',
