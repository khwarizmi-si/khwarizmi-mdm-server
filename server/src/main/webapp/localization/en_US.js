...
document.localization ['en_US'] = {
    ...
    'button.installed.apps': 'Installed applications',
    'device.installed.apps.title': 'Installed applications',
    'device.installed.apps.loading': 'Loading applications…',
    'device.installed.apps.search': 'Search by name or package',
    'device.installed.apps.system.show': 'Show system apps',
    'device.installed.apps.empty': 'No applications reported for this device yet.',
    'device.installed.apps.col.name': 'Name',
    'device.installed.apps.col.package': 'Package',
    'device.installed.apps.col.version': 'Version',
    'device.installed.apps.col.type': 'Type',
    'device.installed.apps.type.system': 'System',
    'device.installed.apps.type.user': 'User',
    'button.app.usage': 'App activity',
    'button.device.location': 'Device location',
    'button.device.command.lock': 'Lock device',
    'button.device.command.reboot': 'Reboot device',
    'button.device.command.wipe': 'Factory reset',
    'device.location.title': 'Device location',
    'device.location.loading': 'Loading location...',
    'device.location.empty': 'No location has been reported for this device yet.',
    'device.location.map': 'Device location map',
    'device.location.marker': 'Latest reported location',
    'device.location.coordinates': 'Coordinates',
    'device.location.reported': 'Reported',
    'device.location.open': 'Open in OpenStreetMap',
    'device.appusage.title': 'App activity',
    'device.appusage.loading': 'Loading activity…',
    'device.appusage.current': 'Currently / last used',
    'device.appusage.empty': 'No app activity reported. Grant usage-access permission on the device to enable this.',
    'device.appusage.col.time': 'Time',
    'device.appusage.col.name': 'Application',
    'device.appusage.col.package': 'Package',
    'button.ok': 'OK',
    'button.help': 'Help',
    ...
    'question.device.command': 'Send "${command}" command to device "${deviceNumber}"?',
    'question.device.command.wipe.final': 'Factory reset will erase all data on device "${deviceNumber}". Are you absolutely sure?',
    'success.device.command.sent': 'Command has been sent to the device.',
    ...
    'error.device.command.unsupported': 'Unsupported device command',
