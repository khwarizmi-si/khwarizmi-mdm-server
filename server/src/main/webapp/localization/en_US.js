...
document.localization ['en_US'] = {
    ...
    'button.add': 'Add',
    'button.device.export': 'Export CSV',
    'button.device.import': 'Import CSV',
    'device.import.title': 'Import devices from CSV',
    'device.import.hint': 'Upload a CSV file. The first column is the device number (required), the second is the description. Existing devices are updated; missing ones are created. Example header:',
    'device.import.upload': 'Upload',
    'device.import.uploading': 'Importing…',
    'device.import.created': 'Created',
    'device.import.updated': 'Updated',
    'device.import.skipped': 'Skipped',
    'device.import.errors': 'Errors',
    'error.device.import.nofile': 'Please choose a CSV file first',
