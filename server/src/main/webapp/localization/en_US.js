...
document.localization ['en_US'] = {
    ...
    'question.device.lock': 'Lock device ${deviceNumber} now?',
    'question.device.reboot': 'Reboot device ${deviceNumber} now?',
    'question.device.wipe': 'Factory reset device ${deviceNumber}? This erases ALL data on the device.',
    'question.device.wipe.confirm': 'This action is IRREVERSIBLE. Really factory reset ${deviceNumber}?',
    'success.device.command.sent': 'Command sent to the device',
    'error.device.command.invalid': 'Unknown device command',
