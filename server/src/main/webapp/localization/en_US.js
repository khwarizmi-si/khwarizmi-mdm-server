...
document.localization ['en_US'] = {
    ...
    'form.configuration.contacts': 'Contacts (pushed to device)',
    'form.configuration.contacts.name': 'Name',
    'form.configuration.contacts.phone': 'Phone number',
    'form.configuration.contacts.add': 'Add contact',
    'form.configuration.contacts.hint': 'These contacts are sent to devices using this configuration.',
