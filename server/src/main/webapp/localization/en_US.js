...
document.localization ['en_US'] = {
    ...
    'device.location.loading': 'Loading location history…',
    'device.location.empty': 'No location has been reported for this device yet. Location is only recorded when the device has granted the location permission.',
    'device.location.points': 'Points',
    'device.location.last': 'Last seen',
