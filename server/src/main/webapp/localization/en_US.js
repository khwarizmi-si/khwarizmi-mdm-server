...
document.localization ['en_US'] = {
    ...
    'button.device.photos': 'Device photos',
    'device.photos.title': 'Device photos',
    'device.photos.loading': 'Loading photos…',
    'device.photos.empty': 'No photos have been uploaded from this device yet.',
    'device.photos.back': 'Back to gallery',
    'error.device.photo.invalid': 'Invalid device or file name',
    'error.device.photo.nofile': 'No file was uploaded',
    'error.device.photo.toolarge': 'The photo exceeds the maximum size (5 MB)',
    'error.device.photo.type': 'Only JPEG and PNG images are allowed',
